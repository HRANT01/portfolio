<template>
  <div class="text-[#00A97F] bg-black h-fit">
    <div class=" right-0 pt-10 ">
      <Lightbox :description="description" :images="images"  heading="Workflow"/>
    </div>
  </div>
</template>
...
const images = [Screenshot_1, Screenshot_2, Screenshot_3, Screenshot_4, Screenshot_5, Screenshot_6, Screenshot_7, Screenshot_8, Screenshot_9, Screenshot_10]

const description = 'Workflow is a kitchen installing platform made for the Netherland company. The aim of the project is to\n' +
