<template>
  <div class="h-full overflow-y-scroll" ref="scrollSection">
    ...
    <div class="w-full mainBlock fixed overflow-hidden z-[1000]">
      <NavBar
        :active-tab="activeTab"
        :menu-items="menuItems"
        @select-menu-item="scrollToSection($event)"
      />
    </div>
    <CursorAnimation />
    <!-- Custom cursor -->
    <Stardrops />
    <!-- Include the stardrop animation here -->
    ...
    <div
      id="Toolset"
      ref="toolsetSection"
      class="toolset bg-black min-h-[45em] h-auto"
    >
      <Toolset />
    </div>
    <div
      ...
      class="experience h-auto bg-black"
    >
      <Experience />
    </div>
...
import CursorAnimation from "../components/UI/CursorAnimation.vue";
import Stardrops from "../components/UI/StarDrops.vue";
...
const observers = {
  About: useIntersectionObserver(aboutSection, handleIntersection, {
    threshold: 0.5,
  }),
  ...
  Contact: useIntersectionObserver(contactSection, handleIntersection, {
    threshold: 0.5,
  }),
};
